...
module Boukensha
  ...
  def self.run(
    ...
    be = case backend
         ...
         when :zai          then Backends::Zai.new(api_key: api_key, model: model)
         else raise ArgumentError, "Unknown backend #{backend.inspect}. Use :anthropic, :openai, :gemini, :ollama, :ollama_cloud, or :zai."
         end
...
require_relative "boukensha/world/observer"
require_relative "boukensha/world/pathfind"
...
require_relative "boukensha/backends/zai"
