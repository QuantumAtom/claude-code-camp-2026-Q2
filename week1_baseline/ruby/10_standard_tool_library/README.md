...
- It worked, but the gem for the MudManager had to be hardcoded in the Gem file. 
- Claude Sonnet took 18.3k tokens just for basically a status check. That seems like a lot.
- Claude Haiku 4.5 took only 10.6k tokens for the same information.

For status checks, it might be worth coding in logic to use lightweight models. 
